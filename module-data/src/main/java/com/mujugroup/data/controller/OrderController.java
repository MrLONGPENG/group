...
public class OrderController {
    ...
    public String info(@ApiParam(value = "代理商ID") @RequestParam(name = "aid", defaultValue = "0") String aid
            ...
            , @ApiParam(value = "did") @RequestParam(value = "did", required = false, defaultValue = "") String did
        ...
        RequestTo to = new RequestTo(ids[0], ids[1], ids[2], orderType, startTime, stopTime, pageNum, pageSize,tradeNo,did);
